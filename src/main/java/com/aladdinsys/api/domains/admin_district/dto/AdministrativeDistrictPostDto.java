...
public record AdministrativeDistrictPostDto(
    @NotNull(message = "연도는 필수입니다.") String standardYear,
    @NotNull(message = "시군구는 필수입니다.") @NotBlank(message = "시군구는 공백이 될 수 없습니다.")
        String cityCountyDistrictName,
    @NotNull(message = "행정동 이름은 필수입니다.") @NotBlank(message = "행정동은 공백이 될 수 없습니다.")
        String administrationName,
    @NotNull(message = "항목 이름은 필수입니다.") @NotBlank(message = "항목 공백이 될 수 없습니다.") String itemName,
