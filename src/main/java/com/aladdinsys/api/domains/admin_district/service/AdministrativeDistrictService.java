...
public class AdministrativeDistrictService {
  ...
  public AdministrativeDistrictResponseDto findById(final Long id) {
    AdministrativeDistrict entity =
        repository
            .findAdministrativeDistrictById(id)
  ...
  public List<AdministrativeDistrictResponseDto> findAll() {
    List<AdministrativeDistrict> entities = repository.findAll();

    return entities.stream()
        .map(
            entity ->
                AdministrativeDistrictResponseDto.of(
                    entity.getId(),
  ...
  public Long save(final AdministrativeDistrictPostDto dto) {
    AdministrativeDistrict entity =
        AdministrativeDistrict.builder()
    ...
    if (entity.getStandardYear() == null) {
      throw new CustomException(ErrorCode.NOT_FOUND);
    }

    repository
        .findAdministrativeDistrictByColumns(
            dto.standardYear(),
            dto.cityCountyDistrictName(),
            dto.administrationName(),
            dto.itemName(),
            dto.dataValue())
        .ifPresent(
            district -> {
  ...
  public void put(final Long id, final AdministrativeDistrictPostDto dto) {
    AdministrativeDistrict fetch =
        repository.findById(id).orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND));
  ...
  public void patch(final Long id, final AdministrativeDistrictPatchDto dto) {
    ...
    Optional.ofNullable(dto.cityCountyDistrictName())
        .ifPresent(fetch::patchCityCountyDistrictNameNm);
