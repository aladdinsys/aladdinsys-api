...
public class AdministrativeDistrict extends BaseEntity {
    ...
    @Builder
    public AdministrativeDistrict(Long id, String standardYear, String cityCountyDistrictName, String administrationName, String itemName, String dataValue) {
        this.id = id;
    ...
    public void update(String standardYear, String cityCountyDistrictName, String administrationName, String itemName, String dataValue) {
        this.standardYear = standardYear;
        this.cityCountyDistrictName = cityCountyDistrictName;
        this.administrationName = administrationName;
        this.itemName = itemName;
