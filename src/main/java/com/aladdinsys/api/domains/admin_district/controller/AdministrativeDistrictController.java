...
public class AdministrativeDistrictController {
  ...
  @GetMapping("/{id}")
  public DataResponseBody<AdministrativeDistrictResponseDto> getAdministrativeDistrict(
  ...
  public ResponseBody put(
      @PathVariable Long id, @Valid @RequestBody AdministrativeDistrictPostDto dto) {
    service.put(id, dto);
  ...
  public ResponseBody patch(
      @PathVariable Long id, @Valid @RequestBody AdministrativeDistrictPatchDto dto) {
