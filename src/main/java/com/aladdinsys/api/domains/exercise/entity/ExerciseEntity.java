...
@Entity
@Table(
    name = "tb_exercise_facility",
    uniqueConstraints = {
      @UniqueConstraint(
          columnNames = {
            "standard_year",
            "large_exercise_facility",
            "middle_exercise_facility",
            "item_name"
          })
    })
...
public class ExerciseEntity {
  ...
  public void patchStdYy(String standardYear) {
    this.standardYear = standardYear;
  }

  public void patchLargeExerciseFacility(String largeExerciseFacility) {
    this.largeExerciseFacility = largeExerciseFacility;
  }

  public void patchMiddleExerciseFacility(String middleExerciseFacility) {
    this.middleExerciseFacility = middleExerciseFacility;
  }

  public void patchItemNm(String itemName) {
    this.itemName = itemName;
  }
