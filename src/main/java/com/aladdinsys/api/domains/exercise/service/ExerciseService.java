/* (C) 2023 */
package com.aladdinsys.api.domains.exercise.service;
...
import com.aladdinsys.api.domains.exercise.repository.ExerciseRepository;
...
public class ExerciseService {
  ...
  public ExerciseResponseDto findById(final Long id) {
    ...
    return ExerciseResponseDto.of(
        entity.getId(),
        entity.getStandardYear(),
        entity.getLargeExerciseFacility(),
        entity.getMiddleExerciseFacility(),
        entity.getItemName(),
        entity.getDataValue());
  }
  ...
  public void updateExercise(final Long id, final ExercisePostDto dto) {
    ExerciseEntity fetch =
        repository.findById(id).orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND));
    fetch.update(
        dto.standardYear(),
        dto.largeExerciseFacility(),
        dto.middleExerciseFacility(),
        dto.itemName(),
        dto.dataValue());
  }
